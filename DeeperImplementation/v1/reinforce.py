...
class PolicyNet(nn.Module):
    def __init__(self, n_actions, img_res, n_hidden_layers=4, n_hidden_nodes=32, learning_rate=0.01):
        ...
        self.history_backbone = torch.nn.Sequential(
            torch.nn.Linear(3, n_hidden_nodes),
            torch.nn.ReLU(),
        ...
        self.head = torch.nn.Sequential(
            torch.nn.Linear(2336, n_hidden_nodes),
            torch.nn.ReLU(),
            torch.nn.Linear(n_hidden_nodes, n_hidden_nodes),
            torch.nn.ReLU(),
    ...
    def forward(self, state):
        ...
        x_hist = self.history_backbone(pos)
...
class Reinforce:
    ...
    def __init__(self, environment, n_actions=7, learning_rate=0.001,
                 episodes=100, guided_episodes=100, gamma=0.01, dataset_max_size=4, entropy_coef=0.01, img_res=10):
